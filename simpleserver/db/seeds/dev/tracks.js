  ...
  return knex('songs').del()
    .then(function () {
      ...
      return knex('songs').insert([
        ...
        {id: 4, title: 'Elevate This Sound', artist: 'Calyx, Teebee', album: 'Elevate This Sound', audio_url: 'http://192.168.1.64:8080/tune4.mp3', duration_millis: 315637, ship_id: 1, order: 4},

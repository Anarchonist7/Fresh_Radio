  ...
  return knex('songs').del()
    .then(function () {
      ...
      return knex('songs').insert([
        ...
        {id: 6, title: 'Ghost Ship', artist: 'Bonobo', album: 'Black Sands Remixed', duration_millis: 241789, audio_url: 'http://' + LOCALHOST + ':' + PORT + '/08%20Ghost%20Ship.mp3', ship_id: 1, order: 6},

  ...
  return knex('songs').del()
    .then(function () {
      ...
      return knex('songs').insert([
        {id: 1, title: 'Rouge', artist: 'TOKiMONSTA', album: 'Lune Rouge', audio_url: 'https://s3-us-west-2.amazonaws.com/pirate-radio/tune1.mp3', duration_millis: 133198, ship_id: 1, order: 1},
        {id: 2, title: 'Estrange (Feat. Io Echo)', artist: 'TOKiMONSTA', album: 'Lune Rouge', audio_url: 'https://s3-us-west-2.amazonaws.com/pirate-radio/tune2.mp3', duration_millis: 258011, ship_id: 1, order: 2},
        {id: 3, title: 'Cirrus', artist: 'Bonobo', album: 'The North Borders', audio_url: 'https://s3-us-west-2.amazonaws.com/pirate-radio/tune3.mp3', duration_millis: 349257, ship_id: 1, order: 3},
        {id: 4, title: 'Elevate This Sound', artist: 'Calyx, Teebee', album: 'Elevate This Sound', audio_url: 'https://s3-us-west-2.amazonaws.com/pirate-radio/tune4.mp3', duration_millis: 315637, ship_id: 1, order: 4},
        ...
        {id: 6, title: 'Ghost Ship', artist: 'Bonobo', album: 'Black Sands Remixed', duration_millis: 241789, audio_url: 'https://s3-us-west-2.amazonaws.com/pirate-radio/08+Ghost+Ship.mp3', ship_id: 1, order: 6},

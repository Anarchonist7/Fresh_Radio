  ...
  return knex('ships').del()
    .then(function () {
      ...
      return knex('ships').insert([
        ...
        {id: 2, name: "jacks-jams", active: false, path: 'http://localhost', user_id: 2, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 44},
        ...
        {id: 8, name: "gapper-day", active: false, path: 'http://localhost', user_id: 4, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 0},

  ...
  return knex('ships').del()
    .then(function () {
      ...
      return knex('ships').insert([
        {id: 1, name: "barbosa-beats", active: false, path: 'no path', user_id: 1, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 2},
        {id: 2, name: "pirate-punk", active: false, path: 'no path', user_id: 2, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 3},
